...
const Fade = styled.div`
  ...
  &::before {
    ...
    opacity: ${props => (props.faded ? '0.3' : '0')};
    z-index: ${props => (props.faded ? '1' : '-1')};
  }
`;
  ...
  render() {
    return (
      <main>
        ...
        <CategoryHeader blabla={this.handleClick} parentOpened={this.state.isOpened} />
        <Fade faded={this.state.isOpened}>
